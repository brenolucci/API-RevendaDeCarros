...
try {
    if (!empty($_FILES['arquivo'])):
        ...
        if (!move_uploaded_file($_FILES['arquivo']['tmp_name'], $dir . $newName)):
            throw new Exception("Falha movendo o arquivo {$_FILES['arquivo']['name']} o servidor com o novo nome {$newName} no servidor!");
        endif;
        echo '</pre>';
        die;
    endif;
