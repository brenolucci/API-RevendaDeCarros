...
try {
    if (!empty($_FILES['files'])):
        ...
        $msg = 'Arquivos enviados para o servidor com sucesso!';
    endif;
} catch (\Exception $e) {
    $msg = $e->getMessage();
}
...
<form action="<?= $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
    <div>
        <label for="arquivo">Selecione os arquivos para upload</label>
        <input type="file" name="files[]" id="arquivo" multiple />
    </div>
    <div>
